...
/// <summary>
/// Proves that the OMX format supports true streaming:
...
public class StreamingTests : IDisposable
{
    ...
    private string TempFile(string name = "streaming.omx") => Path.Combine(_tempDir, name);
    ...
    {
        var path = TempFile("multi_flush.omx");
    ...
    {
        var path = TempFile("segments.omx");
    ...
    {
        var path = TempFile("bounded_memory.omx");
    ...
    {
        var path = TempFile("multi_ch_stream.omx");
    ...
    {
        var path = TempFile("raw_stream.omx");
    ...
    {
        var path = TempFile("stats_stream.omx");
